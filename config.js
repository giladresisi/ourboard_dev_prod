module.exports = {
    ...
    S3_ACCESS_KEY_ID: process.env.S3_ACCESS_KEY_ID || 'AKIAI6TS23CYQUXKZOWQ',
    S3_SECRET_ACCESS_KEY: process.env.S3_SECRET_ACCESS_KEY || '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',
